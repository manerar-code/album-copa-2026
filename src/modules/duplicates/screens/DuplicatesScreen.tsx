...
import { View, Text, SectionList, TouchableOpacity, StyleSheet, SafeAreaView, Share } from 'react-native';
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <SectionList
        ...
        ListEmptyComponent={
          <EmptyState emoji="✅" title="Nenhuma repetida" subtitle="Você não tem figurinhas duplicadas." />
        }
        ListFooterComponent={
          sections.length > 0 ? (
...
const styles = StyleSheet.create({
  ...
  countBadge: { backgroundColor: '#FEF9E7', borderRadius: radius.full, paddingHorizontal: spacing.sm, paddingVertical: 2 },
  ...
  chip: { backgroundColor: colors.duplicate.background, borderWidth: 1, borderColor: colors.duplicate.border, borderRadius: radius.sm, paddingVertical: 6, paddingHorizontal: 10 },
  chipText: { fontSize: 12, fontWeight: '600', color: colors.duplicate.text },
  shareBtn: { backgroundColor: '#25D366', borderRadius: radius.lg, padding: spacing.md, margin: spacing.md, alignItems: 'center' },
